      ...
      <div className={"row"}>
        <div className={"col"}>
          <section>
            ...
            <p>
              Welcome to the Global W.E./Global Warming Express Online
              Curriculum Guide
            </p>

            <p>
              As you can see, the Online Curriculum includes books (written and
              spoken) and discussions about the books (also written and spoken).
              Each class or lesson is called a Session. Why Session? The word
              session is a little less like lesson or class. Although we may be
              joining your class or lesson, and although we cover a good deal of
              science, history and geography, we’d like your students to
              associate this content with a break from academics.
            </p>
          ...
          <section>
            <h1>Common Ground</h1>
            <p>
              -You will notice that we begin and end with this book. Why do we
              choose to do this? We tend to see the simple message of the book
              as an all-encompassing theme of the materials involved.
            </p>
            <p>
              Be sure to let the students do the reading of <u>Common Ground</u>
          ...
          <section>
            <p>
              <b>A note about the books:</b>
            </p>
            <p>Kids love real books!</p>
            <p>
              Hard copies of <u>Common Ground</u> and the <u>Sunlight Series</u>{" "}
              books are available through Scholastic Books.
            </p>
            <p>
              <u>The Global Warming Express</u> can be found on many online
              distributor websites.
            </p>
            <p>
              We love questions and comments! For either, simply write to{" "}
              <a
                ...
                className={"textLink"}
              >
                info@theglobalwarmingexpress.org
              </a>
              .
            </p>
            ...
            <p>
              <strong>
                If you are interested in bringing the Global Warming Express
            ...
            <p>
              ...
              <strong>The Global Warming Express!</strong>
            </p>
