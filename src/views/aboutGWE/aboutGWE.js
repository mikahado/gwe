  ...
  return (
    <div>
      <div className={"aboutGWE"}>
        <h1 className={'pageTitle'}>About GWE</h1>

        <div className={'pageBody p-2'}>

          <section>
            <h2 className={'sectionHeader'}>What Is The GWE?</h2>
            <p>
          ...
          <section>
            <h3 className={'sectionHeader'}>How Did The GWE begin?</h3>
            <p>
          ...
          <section>
            <h3 className={'sectionHeader'}>What Does The GWE Do Today?</h3>
            <p>
