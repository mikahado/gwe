...
export function filterResources(filtersObj){
    ...
    resources.forEach( resource =>{
        ...
        if(
            ...
            if (typeFilter(compiledFilters.types, resource.type) && !resourceResults[age][categoryLabels[resource.type]]){
                ...
                if (!checkDuplicate(resource, resourceResults[age][categoryLabels[resource.type] ] ) ){
                    resourceResults[age][categoryLabels[resource.type]].push(resource);
                }
            }
    ...
    Object.keys(resourceResults).forEach( ageKey =>{
        ...
        function compare(a,b){
            ...
            const categoryPriority = ['Videos','Articles','Publications','Information','People','Businesses'];
            ...
            } else if(categoryPriority.indexOf(a.heading) < categoryPriority.indexOf(b.heading)) {
                return -1;
            } else {
                return 1;
            }
