...
export const dramas = {
  blanketDrama: new Drama(
    "blanketDrama",
    new MultiLingual(
      "Blanket Drama / Experiment",  // Update titles for dramas
      "Drama de Cobija / Experimento",
      "Expérience de couverture"
    ),
    new MultiLingual(
      "Learn what happens when the earth is covered in greenhouse gases."  // Update descriptions
    ),
    "",
    new MultiLingual(
      [
        `A globe of the earth`,  // Update supplies
      ...
      [
        <div>
          ...
          <p>
            ...
            Explain that this is a facsimile of the earth’s atmosphere. <br />{" "}
            Ask the students what the atmosphere is. Discuss. <br />
            <br />
            Remind them that, up until about 100 years ago, the atmosphere kept
            our planet just warm enough- not too hot and not too cold. Remind
            them that some people call it the Goldilocks effect. (explain) Tell
            them that without the atmosphere, we would be Super Cold and that
            even if they put 20 sleeping bags over themselves, they would
            freeze. <br /> So, we really need the atmosphere.
          </p>
          ...
          <p>
            ...
            You can introduce the terms Greenhouse Gases and Fossil Fuels, but
            no need for a lot of detail -we will get to that.
          </p>
          ...
          <p>
            ...
            Instead of a nice thin atmosphere, we now have a thick blanket.{" "}
            <br />
            Why? <br />
            Because all of the greenhouse gases made by the smoke from the
            burning of fossil fuels, have mostly stayed in the atmosphere, we
            now have a thicker blanket.
          </p>

          <p>
            Close your eyes and think about when you are sleeping on a warm,
            spring night. You have a blanket over your sheet. But you start to
            get too hot! What do you do? Open your eyes– <br />
            Yes! You kick off or take off your blanket. <br />
            Well our Earth is now trying to take off the blanket because it’s
            too hot, but Earth doesn’t have any arms or legs! <br />
            How would that feel if you were the Earth? <br />
            Let’s try it! <br />
            Ask for a volunteer. <br />
            Tell the volunteer, once they come over, that you are going to put
            the blanket over their head for the count of 5. <br />
          ...
          <h2>
            Now divide the group into pairs and let the kids try both versions
            for each other.
          </h2>
          <p>
          ...
          <p>
            ...
            more about the Greenhouse Effect, which is not too strong, and
